...
export const COURSE_CONTENT: Record<number, Lesson> = {
  ...
  5: {
    ...
    essential: {
      ...
      exercise: {
        objective: "Replace a vague brief with a spoken brief AI can actually execute against",
        doneWhen: "You have one clear goal, one honest why, and one named constraint — and AI output that addresses that exact brief.",
        timeMinutes: 8,
        steps: [
          {
            task: "01",
            ...
            items: [
              "Write your goal in one sentence — plain language, no jargon.",
              "A destination, not a direction.",
            ],
          },
          {
            task: "02",
            ...
            items: [
              ...
              "Write what changes if you get it right.",
            ],
          },
          {
            task: "03",
        ...
        prompt: "I need help executing on a real goal.\nThe real goal is [1. one sentence — plain language, no jargon].\nThis matters because [2. why it matters now] and [3. what changes if we get it right].\nWe will not [4. the constraint nobody named in the meeting].\nHelp me execute against this. Not the vague version. Not the nodded version. This one.\n-----------\nIf any bracket above is not filled in, do not proceed. Ask me one question at a time. Start with the goal. Then the why. Then what changes if we get it right. Then the constraint. Do not move to the next question until I have answered fully. When I answer, reflect back what I said and ask — is this the real destination or the Abilene version?",
      },
    },
    ...
    advanced: {
      ...
      exercise: {
        objective: "Upgrade a spoken brief into a full True North that AI can act on without interpretation",
        doneWhen: "You have all six True North components written for one real brief, and two AI outputs to compare — the spoken version against the True North version.",
        timeMinutes: 10,
        steps: [
          {
            task: "01",
            title: "Start from your spoken brief",
            items: [
              "Take your spoken brief from the Essential exercise.",
              "Find your goal, your why, and your constraints.",
            ],
          },
          {
            task: "02",
            title: "Upgrade to a full True North",
            items: [
              "Write all six components: Narrative, Objective, Restrictions, Tactical, Start Here, Headline.",
              "Do not skip any. Write every one before moving on.",
            ],
          },
          {
            task: "03",
            title: "Use the prompt",
            items: [
              "Paste your spoken brief into AI first. Note the output.",
              "Then paste the True North prompt below. Compare the two.",
            ],
          },
        ],
        prompt: "You are a strategic advisor applying True North. I will give you my spoken brief: [1. paste your goal, why, and constraints here]. Respond with the following structure only:\nN — Narrative: [2. why this problem exists for my team right now] O — Objective: We need ideas for [3. fill in the blank, one sentence, no jargon] R — Restrictions: We will never [4. two decisions, not limits, decisions] T — Tactical: [5. deadline, budget, non-negotiables, the hard facts] H — Start Here: [6. one reference point, a brand, campaign, or person] Headline: [7. two words maximum]\nDo not draft ideas. Only extract structure. Make every component specific to my situation. If anything is vague, ask me one question at a time to sharpen it before proceeding.\nIf any bracket above is not filled in, do not proceed. Ask me one question at a time. Start with the spoken brief. Then sharpen each component one by one. When I answer, reflect back what I said and ask: is this specific enough that your team knows what not to do tomorrow morning?",
      },
    },

    learnMore: [
      { title: "Notebook LM", url: "http://tiny.cc/TN_notebook", type: "tool" },
      { title: "Miro Template", url: "http://tiny.cc/TN_miro_temp", type: "tool" },
      { title: "NotebookLM1", url: "http://tiny.cc/day5_notebook", type: "tool" },
    ],
  },
